...
const GalaxyGridPage = () => {
  ...
  const projects = [
    ...
    { imageUrl: ggCpu, id: '2', info: 'CPU Wins. CPU is automatically defaults to O. Each win is worth 10 points.' },
    { imageUrl: ggPlayer, id: '3', info: 'Player Wins. Player automatically defaults to X.' }
  ];
